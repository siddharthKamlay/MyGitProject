    ...
    AS_Form_b5efcba627994b17a79cd6dcab8e6a47: function AS_Form_b5efcba627994b17a79cd6dcab8e6a47(eventobject) {
        ...
        function INVOKE_SERVICE_j9260bc7feed4f0784e30f5319b2030f_Callback(Productline) {
            ...
            if (Productline.opstatus == 0) {
                var tempCollection4518 = [];
                var tempData7265 = Productline.records;
                for (var each3823 in tempData7265) {
                    var shouldShow = typeof tempData7265[each3823]["x_0024FILES"] !== 'undefined' && tempData7265[each3823]["x_0024FILES"] && tempData7265[each3823]["x_0024FILES"].length > 0
                    tempCollection4518.push({
                        "lblProductLine1": {
                            "text": tempData7265[each3823]["ProductLine"]
                        },
                        "lblForcasted1": {
                            "text": tempData7265[each3823]["Forecasted"]
                        },
                        "lblActual1": {
                            "text": tempData7265[each3823]["Actual"]
                        },
                        "lblVariance1": {
                            "text": tempData7265[each3823]["Variance"]
                        },
                    });
                }
                self.view.segProductline.setData(tempCollection4518);
