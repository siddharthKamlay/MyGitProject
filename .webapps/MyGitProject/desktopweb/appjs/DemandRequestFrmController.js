...
define("DemandRequestFrmControllerActions", {
    ...
    */
    ...
    AS_Form_c9d44fb4d5ad4928932f0eeb9e353e07: function AS_Form_c9d44fb4d5ad4928932f0eeb9e353e07(eventobject) {
        ...
        function INVOKE_SERVICE_jaeb26165b184047aca6d7d11e45e1aa_Callback(DemandRequestSid) {
            voltmx.application.dismissLoadingScreen();
            if (DemandRequestSid.opstatus == 0) {
                taskData = DemandRequestSid.records;
                kony.print("taskData" + JSON.stringify(taskData));
                var tempCollection2758 = [];
                var tempData3117 = DemandRequestSid.records;
                for (var each6954 in tempData3117) {
                    var shouldShow = typeof tempData3117[each6954]["x_0024FILES"] !== 'undefined' && tempData3117[each6954]["x_0024FILES"] && tempData3117[each6954]["x_0024FILES"].length > 0
                    tempCollection2758.push({
                        "lblSKUID1": {
                            "text": tempData3117[each6954]["SKUID"]
                        },
                        "lblName1": {
                            "text": tempData3117[each6954]["Name"]
                        },
                        "lblCategory1": {
                            "text": tempData3117[each6954]["Category"]
                        },
                        "lblStock1": {
                            "text": tempData3117[each6954]["Stock"]
                        },
                        "lblForecasted1": {
                            "text": tempData3117[each6954]["Forecasted"]
                        },
                        "lblEnrichedQTY1": {
                            "text": tempData3117[each6954]["EnrichedQTY"]
                        },
                        "lblRequested1": {
                            "text": tempData3117[each6954]["Requested"]
                        },
                        "lblStatus1": {
                            "text": tempData3117[each6954]["Status"]
                        },
                        "lblRequestedBY1": {
                            "text": tempData3117[each6954]["RequestedBy"]
                        },
                        "lblRequestDate1": {
                            "text": tempData3117[each6954]["RequestDate"]
                        },
                    });
                }
                self.view.segDemandRequest.setData(tempCollection2758);
        ...
        if (DemandRequestSid_inputparam == undefined) {
            var DemandRequestSid_inputparam = {};
        }
        DemandRequestSid_inputparam["serviceID"] = "SKUDemandRequestsSid$DemandRequestSid$get";
        DemandRequestSid_inputparam["options"] = {
            "access": "online",
            "CRUD_TYPE": "get"
        };
        var DemandRequestSid_httpheaders = {};
        DemandRequestSid_inputparam["httpheaders"] = DemandRequestSid_httpheaders;
        var DemandRequestSid_httpconfigs = {};
        DemandRequestSid_inputparam["httpconfig"] = DemandRequestSid_httpconfigs;
        SKUDemandRequestsSid$DemandRequestSid$get = mfobjectsecureinvokerasync(DemandRequestSid_inputparam, "SKUDemandRequestsSid", "DemandRequestSid", INVOKE_SERVICE_jaeb26165b184047aca6d7d11e45e1aa_Callback);
    },
